<!DOCTYPE html>
<!-- https://www.free-css.com/free-css-templates/page286/safecam !-->
<html lang="en">

<head>
    <meta charset="utf-8">
    <title>SecureSales</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        <a href="index.html" class="navbar-brand ms-lg-5">
            <h1 class="display-5 m-0 text-primary">Secure<span class="text-secondary">Sales</span></h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="/page.php?file=about.html" class="nav-item nav-link">About</a>
                <a href="/page.php?file=service.php" class="nav-item nav-link">Service</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                    <div class="dropdown-menu m-0">
                        <a href="/page.php?file=price.html" class="dropdown-item">Pricing Plan</a>
                        <a href="/page.php?file=blog.html" class="dropdown-item">Blog Grid</a>
                        <a href="/page.php?file=blog.html" class="dropdown-item">Blog Detail</a>
                        <a href="/page.php?file=team.html" class="dropdown-item">The Team</a>
                        <a href="/page.php?file=testimonial.html" class="dropdown-item">Testimonial</a>
                    </div>
                </div>
                <a href="contact.html" class="nav-item nav-link">Contact</a>
                <a href="tel:+123456789" class="nav-item nav-link nav-contact bg-secondary text-white px-5 ms-lg-5"><i class="bi bi-telephone-outbound me-2"></i>+61 133 7133 701</a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase animated bounceInDown">Sales with Security</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Secure Sales</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Now Hiring</a>
    ...
    <div class="container-fluid bg-dark text-light mt-5 py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container pt-5">
            <div class="row g-5">
                ...
                <div class="col-12">
<form class="mx-auto" style="max-width: 600px;" action="/newsletter.php" method="post">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-md-0">&copy; <a class="text-white border-bottom" href="#">Secure Sales</a>. Just a Demo.</p>
                </div>
