                        ...
                        <td style="vertical-align: top; width: 550px; padding-left: 15px;">
                            ...
                            <script type="text/javascript">
                                ...
                                async function install(){
                                    Installpage_populate('a=startInstall');
                                    await sleep(1000);                                    
                                    Installpage_populate('a=databaseConnectivity');                            
                                    await sleep(1000);
                                    Installpage_populate('a=databaseConnectivity&user=cats&pass=0p3nc4tz1&host=localhost&name=cats_dev');                                    
                                    await sleep(2000);
                                    Installpage_populate('a=detectRevision');
                                    await sleep(1000);
                                    Installpage_populate('a=selectDBType&type=restore');
                                    await sleep(2000);
                                    Installpage_populate('a=restoreFromBackup');
                                    await sleep(3000);
                                    Installpage_populate('a=mailSettings');
                                    await sleep(2000);
                                    Installpage_populate('a=setMailSettings&mailSupport=None&mailSendmail=null&mailSmtpHost=localhost&mailSmtpPort=587&mailSmtpUsername=user&mailSmtpPassword=password&mailFromAddress=cats@demo.lab');
                                    await sleep(5000);
                                    Installpage_populate('a=setupOptional&list=usZipCodes,false&timeZone=1&dateFormat=dmy');      
                                    await sleep(5000);
                                    };
